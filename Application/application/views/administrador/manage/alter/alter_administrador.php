...
<html>
    <head>
        ...
        <title>SIGE | Atualizar Administrador</title>
...
<div class="col-md-12">
                    ...
                    <div class="col-md-12" >
                        ...
                        <div class="box box-solid" style="height: 500px; ">
                            <div class="box-header text-center"> Insira apenas os campos que deseja atualizar </div>
                            

                            <?php echo form_open_multipart('update/administrador/'.$this->uri->segment(3)); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <!--------------- SENHA --------------->
                                <div class="form-group has-feedback">
                                    <input  name="senha" type="password" class="form-control" minlength="5" maxlength="20" value="<?php echo setValue('senha'); ?>" placeholder="Senha*">
                                ...
                                <div class="form-group has-feedback">
                                    <input   name="conf_senha" type="password" class="form-control" minlength="5" maxlength="20" value="<?php echo setValue('conf_senha'); ?>" placeholder="Confirme a senha*">
                                    <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                                </div>
                                <!--------------- /. CONFIRMAÇÃO DA SENHA --------------->
