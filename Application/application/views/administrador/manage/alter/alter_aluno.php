        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <a href="<?php echo base_url('/manage/aluno'); ?>"> <button class="fa fa-arrow-circle-left btn btn-primary btn-sm"> <small>Voltar</small></button> </a>
                        ...
                        <div class="col-md-12" >
                            ...
                            <div class="box box-primary" style="height: 700px; margin-left: auto; margin-right: auto;">
                                <div class=" box-header register-logo">
                                    <a>Alteração de Aluno</a>
                                </div>


                                <?php
                                echo form_open_multipart('manage/alter/aluno/' . $this->uri->segment(4));


                                //Variaveis do usuário
                                $_POST['primeiroNome'] = $PRIMEIRONOME;
                                $_POST['sobrenome'] = $SOBRENOME;
                                $_POST['nascimento'] = $NASCIMENTO;
                                $_POST['cep'] = $CEP;
                                $_POST['estado'] = $ESTADO;
                                $_POST['rua'] = $RUA;
                                $_POST['cidade'] = $CIDADE;
                                $_POST['bairro'] = $BAIRRO;
                                $_POST['email'] = $EMAIL;
                                $_POST['numresidencia'] = $NUMRESIDENCIA;
                                $_POST['cpf'] = $CPF;
                                $_POST['rg'] = $RG;
                                ...
                                <div class="row" >
                                    <div class="col-md-1">
                                        ...
                                        <div class="user-panel " style="margin-left:10px; margin-top:-10px;">

                                            <div class="image"  >

                                                <img class="img-circle" src="<?php echo $FOTO; ?>" alt="imagem do usuário" />
                                    ...
                                    <div class="col-md-11" >
                                        ...
                                        <div class="form-group has-feedback" style="margin-left: -10px;margin-right: 16px;">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <button type="submit"  class="btn btn-block btn-social btn-primary btn-block btn-flat"><i class="fa fa-pencil"></i> Alterar </button>
