                            ...
                            <div class="box box-solid" >
                              ...
                              <ul class="nav nav-tabs ">
                                <li class="active"><a data-toggle="tab" href="#home">Apresentação</a></li>
                                    <li><a data-toggle="tab" href="#menu1">Bibliografia</a></li>
                                    <li><a data-toggle="tab" href="#menu2">ExtraClasse</a></li>
                                  </ul>
                                  ...
                                  <div class="tab-content box box-solid">
                                    <div id="home" class="tab-pane fade in active content">
                                      ...
                                      <h3>Breve Apresentação</h3>
                                      <p><?php

                                      if(strcmp($APRESENTACAO,'') == 0){
