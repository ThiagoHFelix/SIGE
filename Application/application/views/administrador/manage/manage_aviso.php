    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function confirmaDelete(id) {
                ...
                var retorno = confirm('Este aviso sera removido permanentemente, tem certeza que deseja remover ?');

                if (retorno == true) {

                    window.location = "<?php echo base_url('/remove/aviso/') ?>".concat(id);
            ...
            <div class="content-wrapper">
                ...
                <section class="content" style="height:690px;">
                    ...
                    <div class="col-xs-12">
                        ...
                        echo $this->session->flashdata('mensagem_manageAviso');
                        ?>
                        ...
                        <div class="row" >
                            ...
                            <div class="col-md-2">
                                ...
                                <a href="<?php echo base_url('/cadastro/aviso'); ?>">  <button class="btn btn-app"  >
                                ...
                                <tbody>
                                    ...
                                    if ($table != NULL):
                                        ...
                                        foreach ($table as $row):
                                            ...
                                            $url = base_url('/visualizar/aviso/' . $row['ID']);
                                            ...
                                            echo "
                                                     ...
                                                     <td >
                                                        <div class=\"btn-group\">
                                                            ...
                                                            <a>   <button onclick=\"confirmaDelete(" . $row['ID'] . ")\" class=\"fa fa-remove btn btn-danger\"></button> </a>
