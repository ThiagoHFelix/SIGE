                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="">
                                ...
                                <a href="<?php echo base_url('/visualizar/administrador/'.$this->session->userdata('user_cpf')); ?>" class="btn pull-right btn-default btn-gear" style="width:49%; margin-bottom:10px" > Perfil </a>
